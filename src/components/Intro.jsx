   ...
   return (
      <>
         ...
         <p className={styles.intro}>
            ...
            many inspirational lines.
            <br/><br/>
            So I put together this page to share those quotes with my friends. I hope you find them similarly inspirational. And, get the book. Read it.            
            <br />
            <br />- Dan
         </p>
      </>
